...
const logger = require('./logger'); // returns a logger object
...
emitter.on('logging', arg => logger.log(arg));
 ...
 */
emitter.emit('logging', {message: 'logging a url'}); // emit means making a noise or produce something 
